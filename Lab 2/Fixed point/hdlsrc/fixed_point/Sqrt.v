// -------------------------------------------------------------
// 
// File Name: hdlsrc\fixed_point\Sqrt.v
...
// 
// Module: Sqrt
// Source Path: fixed_point/Subsystem/Sqrt
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Sqrt
  ...
  input   reset;
  input   enb;
  input   signed [63:0] din;  // sfix64_En14
  output  signed [32:0] dout;  // sfix33_En7


  wire [1:0] Root_Square0_temp1;  // ufix2
  wire [65:0] resizedin;  // ufix66_En14
  ...
  reg [31:0] currentRoot32_p;  // ufix32
  reg [31:0] prevRoot_p2_reg [0:1];  // ufix32 [2]
  wire [31:0] prevRoot_p2_reg_next [0:1];  // ufix32 [2]
  wire [31:0] prevRoot_p_2;  // ufix32
  wire signed [32:0] outdata_1;  // sfix33_En7
  ...
  assign resizedin = (din[63] == 1'b1 ? 66'h00000000000000000 :
              {{2{din[63]}}, din});
  ...
  always @(posedge clk or posedge reset)
    begin : root_reg_31_process
      if (reset == 1'b1) begin
        currentRoot32_p <= 32'b00000000000000000000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign prevRoot_p2_reg_next[0] = currentRoot32_p;
